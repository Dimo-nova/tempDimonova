...
(function () {
  ...
  window.I18N = {
    en: {
      ...
      "home.how.s2_body": "Matched to your brand, your tone, your venue. Table ordering, coupon codes, custom sections — whatever your restaurant needs, we build it in.",
      ...
      "features.f2.p1": "<strong style=\"font-weight:600\">Changes go live instantly</strong> — no publishing queue, no waiting on a developer.",
      "features.f2.p2": "<strong style=\"font-weight:600\">Menu in multiple languages</strong> — guests see it in their language automatically.",
      "features.f2.p3": "<strong style=\"font-weight:600\">Fully personalised to your brand</strong> — colours, fonts, and feel built for your restaurant.",
      ...
      "features.f3.p1": "<strong style=\"font-weight:600\">Dish popularity</strong> by week and month — see what's selling and when.",
      "features.f3.p2": "<strong style=\"font-weight:600\">Active dish overview</strong> — all your live items at a glance.",
      "features.f3.p3": "<strong style=\"font-weight:600\">Custom categories</strong> — organise your menu sections your way.",
      ...
      "pricing.title": "Priced around <em style=\"font-family:'Instrument Serif',serif;font-style:italic;color:#B8523A\">your</em> venue.",
      "pricing.intro": "Tell us about your venue and we'll build a number around it. Here's what that always covers.",

      // ---- pricing: what's always included ----
      "pricing.included.eyebrow": "What's always included",
      "pricing.included.title": "Everything every client gets, regardless of venue size.",
      "pricing.included.i1": "Menu structured and built by us, from whatever you have",
      "pricing.included.i2": "Styled to match your existing brand",
      "pricing.included.i3": "Embedded into your existing website — no new site needed",
      "pricing.included.i4": "Unlimited dish, price, and section updates — done by you, instantly",
      "pricing.included.i5": "Dish popularity analytics and weekly digest",
      "pricing.included.i6": "Hosting, security, and software updates — always on",
      "pricing.included.i7": "Real human support — email and WhatsApp",
      "pricing.included.i8": "QR codes for tables and print (optional add-on)",
      "pricing.included.i9": "30-minute onboarding session, video call",

      // ---- pricing: what shapes your quote ----
      "pricing.shape.eyebrow": "What shapes your quote",
      "pricing.shape.intro": "A few things inform the number — and we talk through all of them on the call.",
      "pricing.shape.i1": "Number of dishes and sections",
      "pricing.shape.i2": "Photography — your own, sourced, or arranged",
      "pricing.shape.i3": "One menu or several (drinks, seasonal, events)",
      "pricing.shape.i4": "Languages — one or more",
      "pricing.shape.i5": "How your current website is built",

      // ---- pricing: CTA strip ----
      "pricing.strip.title": "Ready to talk numbers?",
      "pricing.strip.body": "Tell us about your venue and we'll put a quote together on the call.",
      ...
      "pricing.faq.a2": "Edit it yourself, as often as you like. Your monthly rate doesn't change based on how often you update things.",
      ...
      "contact.form.menuurl_label": "Current digital menu",
      "contact.form.menuurl_ph": "https://yourmenu.com",
      "contact.form.menufile_label": "Dish list",
      "contact.form.menufile_ph": "Upload PDF or Excel",
      "contact.form.menufile_hint": "PDF, .xls or .xlsx",
      "contact.form.disclaimer": "We only want to know more about your business. No marketing list.",
      "contact.form.submit": "Request a demo →",

      // ---- contact: side panel ----
      "contact.side.chat_label": "Prefer to chat?",
      "contact.side.chat_body": "Faster than email. We're usually back to you within the hour.",
      ...
      "contact.side.phone_calls_label": "Phone calls",
      "contact.side.phone_lang_en": "· English",
      "contact.side.phone_lang_es": "· Spanish",
    ...
    es: {
      ...
      "home.how.s2_body": "Adaptada a tu marca, tu tono y tu local. Pedidos en mesa, códigos de descuento, secciones personalizadas — lo que necesite tu restaurante, lo construimos.",
      ...
      "features.f2.p1": "<strong style=\"font-weight:600\">Los cambios se publican al instante</strong> — sin cola de publicación, sin esperar a un desarrollador.",
      "features.f2.p2": "<strong style=\"font-weight:600\">Carta en varios idiomas</strong> — los clientes la ven en su idioma automáticamente.",
      "features.f2.p3": "<strong style=\"font-weight:600\">Totalmente personalizada a tu marca</strong> — colores, tipografía y estilo diseñados para tu restaurante.",
      ...
      "features.f3.p1": "<strong style=\"font-weight:600\">Popularidad de los platos</strong> por semana y mes — descubre qué se vende y cuándo.",
      "features.f3.p2": "<strong style=\"font-weight:600\">Vista de platos activos</strong> — todos tus elementos en activo de un vistazo.",
      "features.f3.p3": "<strong style=\"font-weight:600\">Categorías personalizadas</strong> — organiza las secciones de tu carta a tu manera.",
      ...
      "pricing.title": "Precios a medida para <em style=\"font-family:'Instrument Serif',serif;font-style:italic;color:#B8523A\">tu</em> local.",
      "pricing.intro": "Cuéntanos sobre tu local y construiremos un número a medida. Esto es lo que siempre incluye.",

      // ---- pricing: what's always included ----
      "pricing.included.eyebrow": "Qué incluye siempre",
      "pricing.included.title": "Todo lo que recibe cada cliente, independientemente del tamaño del local.",
      "pricing.included.i1": "Carta estructurada y construida por nosotros, con lo que tengas",
      "pricing.included.i2": "Diseñada a juego con tu marca actual",
      "pricing.included.i3": "Integrada en tu web actual — sin necesidad de una web nueva",
      "pricing.included.i4": "Cambios de platos, precios y secciones ilimitados — los haces tú, al instante",
      "pricing.included.i5": "Analíticas de popularidad y resumen semanal",
      "pricing.included.i6": "Alojamiento, seguridad y actualizaciones — siempre activo",
      "pricing.included.i7": "Soporte humano de verdad — correo y WhatsApp",
      "pricing.included.i8": "Códigos QR para mesas y formato impreso (complemento opcional)",
      "pricing.included.i9": "Sesión de bienvenida de 30 minutos, videollamada",

      // ---- pricing: what shapes your quote ----
      "pricing.shape.eyebrow": "Qué define tu presupuesto",
      "pricing.shape.intro": "Hay algunos factores que determinan el número — los hablamos todos en la llamada.",
      "pricing.shape.i1": "Número de platos y secciones",
      "pricing.shape.i2": "Fotografía — la tuya, la de tu web, o la organizamos nosotros",
      "pricing.shape.i3": "Una carta o varias (bebidas, temporada, eventos)",
      "pricing.shape.i4": "Idiomas — uno o varios",
      "pricing.shape.i5": "Cómo está construida tu web actual",

      // ---- pricing: CTA strip ----
      "pricing.strip.title": "¿Listo para hablar de números?",
      "pricing.strip.body": "Cuéntanos sobre tu local y preparamos un presupuesto en la llamada.",
      ...
      "pricing.faq.a2": "Edítala tú mismo, tantas veces como quieras. Tu cuota mensual no varía según la frecuencia de los cambios.",
      ...
      "contact.form.menuurl_label": "Menú digital actual",
      "contact.form.menuurl_ph": "https://tumenu.com",
      "contact.form.menufile_label": "Lista de platos",
      "contact.form.menufile_ph": "Subir PDF o Excel",
      "contact.form.menufile_hint": "PDF, .xls o .xlsx",
      "contact.form.disclaimer": "Solo queremos saber más sobre tu negocio. Sin listas de marketing.",
      "contact.form.submit": "Solicitar una demo →",

      // ---- contact: side panel ----
      "contact.side.chat_label": "¿Prefieres chatear?",
      "contact.side.chat_body": "Más rápido que el correo. Solemos responder en menos de una hora.",
      ...
      "contact.side.phone_calls_label": "Llamadas",
      "contact.side.phone_lang_en": "· Inglés",
      "contact.side.phone_lang_es": "· Español",
    ...
    de: {
      ...
      "home.how.s2_body": "Abgestimmt auf deine Marke, deinen Ton, dein Lokal. Tischbestellungen, Rabattcodes, eigene Bereiche — was dein Restaurant braucht, setzen wir um.",
      ...
      "features.f2.p1": "<strong style=\"font-weight:600\">Änderungen gehen sofort live</strong> — keine Warteschlange, kein Warten auf einen Entwickler.",
      "features.f2.p2": "<strong style=\"font-weight:600\">Karte in mehreren Sprachen</strong> — Gäste sehen sie automatisch in ihrer Sprache.",
      "features.f2.p3": "<strong style=\"font-weight:600\">Vollständig an deine Marke angepasst</strong> — Farben, Schriften und Stil, maßgeschneidert für dein Restaurant.",
      ...
      "features.f3.p1": "<strong style=\"font-weight:600\">Beliebtheit der Gerichte</strong> nach Woche und Monat — sieh, was wann läuft.",
      "features.f3.p2": "<strong style=\"font-weight:600\">Aktive Gerichtsübersicht</strong> — alle aktiven Einträge auf einen Blick.",
      "features.f3.p3": "<strong style=\"font-weight:600\">Eigene Kategorien</strong> — organisiere deine Menübereiche nach deinen Vorstellungen.",
      ...
      "pricing.title": "Preise passend für <em style=\"font-family:'Instrument Serif',serif;font-style:italic;color:#B8523A\">dein</em> Lokal.",
      "pricing.intro": "Erzähl uns von deinem Lokal und wir erstellen ein passendes Angebot. Das ist immer enthalten.",

      // ---- pricing: what's always included ----
      "pricing.included.eyebrow": "Was immer enthalten ist",
      "pricing.included.title": "Alles, was jeder Kunde erhält — unabhängig von der Lokalgröße.",
      "pricing.included.i1": "Karte von uns aufgebaut, mit dem, was du hast",
      "pricing.included.i2": "Gestaltet passend zu deiner bestehenden Marke",
      "pricing.included.i3": "In deine bestehende Website eingebunden — keine neue Website nötig",
      "pricing.included.i4": "Unbegrenzte Änderungen an Gerichten, Preisen und Bereichen — von dir, sofort",
      "pricing.included.i5": "Beliebtheitsanalysen und wöchentliche Zusammenfassung",
      "pricing.included.i6": "Hosting, Sicherheit und Software-Updates — immer aktiv",
      "pricing.included.i7": "Echter menschlicher Support — E-Mail und WhatsApp",
      "pricing.included.i8": "QR-Codes für Tische und Druck (optionale Ergänzung)",
      "pricing.included.i9": "30-minütige Einführungssitzung per Videoanruf",

      // ---- pricing: what shapes your quote ----
      "pricing.shape.eyebrow": "Was dein Angebot bestimmt",
      "pricing.shape.intro": "Einige Faktoren beeinflussen den Preis — wir besprechen sie alle im Gespräch.",
      "pricing.shape.i1": "Anzahl der Gerichte und Bereiche",
      "pricing.shape.i2": "Fotos — deine eigenen, von deiner Website oder von uns organisiert",
      "pricing.shape.i3": "Eine Karte oder mehrere (Getränke, Saison, Events)",
      "pricing.shape.i4": "Sprachen — eine oder mehrere",
      "pricing.shape.i5": "Wie deine aktuelle Website aufgebaut ist",

      // ---- pricing: CTA strip ----
      "pricing.strip.title": "Bereit, über Zahlen zu sprechen?",
      "pricing.strip.body": "Erzähl uns von deinem Lokal und wir erstellen dir im Gespräch ein Angebot.",
      ...
      "pricing.faq.a2": "Ändere sie selbst, so oft du willst. Deine Monatsrate ändert sich nicht je nach Häufigkeit der Änderungen.",
      ...
      "contact.form.menuurl_label": "Aktuelles digitales Menü",
      "contact.form.menuurl_ph": "https://deinemenu.de",
      "contact.form.menufile_label": "Gerichtsliste",
      "contact.form.menufile_ph": "PDF oder Excel hochladen",
      "contact.form.menufile_hint": "PDF, .xls oder .xlsx",
      "contact.form.disclaimer": "Wir möchten nur mehr über dein Business erfahren. Keine Marketingliste.",
      "contact.form.submit": "Demo anfragen →",

      // ---- contact: side panel ----
      "contact.side.chat_label": "Lieber chatten?",
      "contact.side.chat_body": "Schneller als E-Mail. Wir melden uns meist innerhalb einer Stunde.",
      ...
      "contact.side.phone_calls_label": "Anrufe",
      "contact.side.phone_lang_en": "· Englisch",
      "contact.side.phone_lang_es": "· Spanisch",
    ...
    fr: {
      ...
      "home.how.s2_body": "Adaptée à ta marque, ton ton, ton établissement. Commandes à table, codes promo, sections sur mesure — ce que ton restaurant a besoin, on le construit.",
      ...
      "features.f2.p1": "<strong style=\"font-weight:600\">Les modifications sont en ligne instantanément</strong> — pas de file de publication, pas d'attente d'un développeur.",
      "features.f2.p2": "<strong style=\"font-weight:600\">Carte en plusieurs langues</strong> — les clients la voient automatiquement dans leur langue.",
      "features.f2.p3": "<strong style=\"font-weight:600\">Entièrement personnalisée à ta marque</strong> — couleurs, polices et ambiance conçues pour ton restaurant.",
      ...
      "features.f3.p1": "<strong style=\"font-weight:600\">Popularité des plats</strong> par semaine et par mois — voyez ce qui se vend et quand.",
      "features.f3.p2": "<strong style=\"font-weight:600\">Vue des plats actifs</strong> — tous vos éléments en ligne d'un coup d'œil.",
      "features.f3.p3": "<strong style=\"font-weight:600\">Catégories personnalisées</strong> — organisez les sections de votre carte à votre façon.",
      ...
      "pricing.title": "Des prix personnalisés pour <em style=\"font-family:'Instrument Serif',serif;font-style:italic;color:#B8523A\">ton</em> établissement.",
      "pricing.intro": "Parle-nous de ton établissement et nous construisons un chiffre autour de tes besoins. Voici ce qui est toujours inclus.",

      // ---- pricing: what's always included ----
      "pricing.included.eyebrow": "Ce qui est toujours inclus",
      "pricing.included.title": "Tout ce que reçoit chaque client, quelle que soit la taille de l'établissement.",
      "pricing.included.i1": "Carte structurée et construite par nos soins, à partir de ce que tu as",
      "pricing.included.i2": "Mise en forme assortie à ta marque existante",
      "pricing.included.i3": "Intégrée à ton site existant — sans nouveau site nécessaire",
      "pricing.included.i4": "Modifications de plats, prix et sections illimitées — faites par toi, instantanément",
      "pricing.included.i5": "Analyses de popularité et récap hebdomadaire",
      "pricing.included.i6": "Hébergement, sécurité et mises à jour logicielles — toujours actif",
      "pricing.included.i7": "Un vrai support humain — e-mail et WhatsApp",
      "pricing.included.i8": "QR codes pour tables et impression (option supplémentaire)",
      "pricing.included.i9": "Session d'intégration de 30 minutes en visio",

      // ---- pricing: what shapes your quote ----
      "pricing.shape.eyebrow": "Ce qui détermine ton devis",
      "pricing.shape.intro": "Quelques éléments influencent le chiffre — nous les passons tous en revue lors de l'appel.",
      "pricing.shape.i1": "Nombre de plats et de sections",
      "pricing.shape.i2": "Photographie — les tiennes, celles de ton site, ou organisées par nous",
      "pricing.shape.i3": "Une carte ou plusieurs (boissons, saison, événements)",
      "pricing.shape.i4": "Langues — une ou plusieurs",
      "pricing.shape.i5": "Comment ton site actuel est construit",

      // ---- pricing: CTA strip ----
      "pricing.strip.title": "Prêt à parler chiffres ?",
      "pricing.strip.body": "Parle-nous de ton établissement et nous préparons un devis lors de l'appel.",
      ...
      "pricing.faq.a2": "Modifie-la toi-même, aussi souvent que tu veux. Ton tarif mensuel ne change pas selon la fréquence des modifications.",
      ...
      "contact.form.menuurl_label": "Menu numérique actuel",
      "contact.form.menuurl_ph": "https://tonmenu.fr",
      "contact.form.menufile_label": "Liste des plats",
      "contact.form.menufile_ph": "Importer un PDF ou Excel",
      "contact.form.menufile_hint": "PDF, .xls ou .xlsx",
      "contact.form.disclaimer": "On veut juste en savoir plus sur ton établissement. Pas de liste marketing.",
      "contact.form.submit": "Demander une démo →",

      // ---- contact: side panel ----
      "contact.side.chat_label": "Tu préfères discuter ?",
      "contact.side.chat_body": "Plus rapide que l'e-mail. Nous répondons en général en moins d'une heure.",
      "contact.side.chat_btn": "Ouvrir WhatsApp",
      "contact.side.old_label": "Ou, à l'ancienne",
      "contact.side.email_label": "E-mail",
      "contact.side.phone_label": "Téléphone",
      "contact.side.phone_calls_label": "Appels téléphoniques",
      "contact.side.phone_lang_en": "· Anglais",
      "contact.side.phone_lang_es": "· Espagnol",
      // ---- form validation errors ----
    ...
    pt: {
      ...
      "home.how.s2_body": "Ajustada à tua marca, ao teu tom, ao teu espaço. Pedidos à mesa, códigos de desconto, secções personalizadas — o que o teu restaurante precisar, nós construímos.",
      ...
      "features.f2.p1": "<strong style=\"font-weight:600\">As alterações ficam online de imediato</strong> — sem filas de publicação, sem esperar por um programador.",
      "features.f2.p2": "<strong style=\"font-weight:600\">Ementa em vários idiomas</strong> — os clientes veem-na automaticamente no seu idioma.",
      "features.f2.p3": "<strong style=\"font-weight:600\">Totalmente personalizada à tua marca</strong> — cores, tipos de letra e estilo feitos para o teu espaço.",
      ...
      "features.f3.p1": "<strong style=\"font-weight:600\">Popularidade dos pratos</strong> por semana e mês — vê o que vende e quando.",
      "features.f3.p2": "<strong style=\"font-weight:600\">Vista de pratos ativos</strong> — todos os teus itens em linha num relance.",
      "features.f3.p3": "<strong style=\"font-weight:600\">Categorias personalizadas</strong> — organiza as secções da tua ementa à tua maneira.",
      ...
      "pricing.title": "Preços à medida para <em style=\"font-family:'Instrument Serif',serif;font-style:italic;color:#B8523A\">o teu</em> espaço.",
      "pricing.intro": "Fala-nos do teu espaço e construímos um valor à tua medida. Isto é o que está sempre incluído.",

      // ---- pricing: what's always included ----
      "pricing.included.eyebrow": "O que está sempre incluído",
      "pricing.included.title": "Tudo o que cada cliente recebe, independentemente do tamanho do espaço.",
      "pricing.included.i1": "Ementa estruturada e construída por nós, com o que tiveres",
      "pricing.included.i2": "Desenhada a condizer com a tua marca atual",
      "pricing.included.i3": "Integrada no teu site atual — sem precisar de um site novo",
      "pricing.included.i4": "Alterações de pratos, preços e secções ilimitadas — feitas por ti, instantaneamente",
      "pricing.included.i5": "Análises de popularidade e resumo semanal",
      "pricing.included.i6": "Alojamento, segurança e atualizações de software — sempre ativo",
      "pricing.included.i7": "Apoio humano de verdade — e-mail e WhatsApp",
      "pricing.included.i8": "Códigos QR para mesas e impressão (extra opcional)",
      "pricing.included.i9": "Sessão de integração de 30 minutos por videochamada",

      // ---- pricing: what shapes your quote ----
      "pricing.shape.eyebrow": "O que define o teu orçamento",
      "pricing.shape.intro": "Há alguns fatores que influenciam o valor — falamos de todos eles na chamada.",
      "pricing.shape.i1": "Número de pratos e secções",
      "pricing.shape.i2": "Fotografia — a tua, do teu site, ou organizamos nós",
      "pricing.shape.i3": "Uma ementa ou várias (bebidas, época, eventos)",
      "pricing.shape.i4": "Idiomas — um ou vários",
      "pricing.shape.i5": "Como o teu site atual está construído",

      // ---- pricing: CTA strip ----
      "pricing.strip.title": "Pronto para falar de valores?",
      "pricing.strip.body": "Fala-nos do teu espaço e preparamos um orçamento na chamada.",
      ...
      "pricing.faq.a2": "Edita-a tu mesmo, tantas vezes quantas quiseres. A tua mensalidade não muda consoante a frequência das alterações.",
      ...
      "contact.form.menuurl_label": "Menu digital atual",
      "contact.form.menuurl_ph": "https://teuMenu.pt",
      "contact.form.menufile_label": "Lista de pratos",
      "contact.form.menufile_ph": "Carregar PDF ou Excel",
      "contact.form.menufile_hint": "PDF, .xls ou .xlsx",
      "contact.form.disclaimer": "Só queremos saber mais sobre o teu negócio. Sem listas de marketing.",
      "contact.form.submit": "Pedir uma demo →",

      // ---- contact: side panel ----
      "contact.side.chat_label": "Preferes conversar?",
      "contact.side.chat_body": "Mais rápido do que o e-mail. Costumamos responder em menos de uma hora.",
      "contact.side.chat_btn": "Abrir WhatsApp",
      "contact.side.old_label": "Ou, à moda antiga",
      "contact.side.email_label": "E-mail",
      "contact.side.phone_label": "Telefone",
      "contact.side.phone_calls_label": "Chamadas",
      "contact.side.phone_lang_en": "· Inglês",
      "contact.side.phone_lang_es": "· Espanhol",
      // ---- form validation errors ----
