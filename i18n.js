...
(function () {
  ...
  window.I18N = {
    en: {
      ...
      "pricing.intro": "We don't publish a fixed price list. Every venue is different — menu size, branding, existing tech — so we quote each client individually after a short call.",
      ...
      "pricing.setup.price": "Your quote",
      "pricing.setup.price_note": "One-time, billed when you go live. We work out the number together on the call.",
      ...
      "pricing.monthly.price_amt": "Your rate",
      "pricing.monthly.price_per": "/mo",
      "pricing.monthly.price_note": "Billed monthly, agreed on the call. Cancel any time, on a month's notice.",
      ...
      // ---- pricing: CTA strip ----
      "pricing.strip.title": "Prices are personal — no two venues are the same.",
      "pricing.strip.body": "A 7-dish café and a 60-dish gastropub aren't the same job. Tell us about your venue and we'll give you a number on the call.",
    ...
    es: {
      ...
      "pricing.intro": "No publicamos tarifas fijas. Cada local es diferente — tamaño de carta, marca, tecnología — así que presupuestamos a cada cliente individualmente tras una breve llamada.",
      ...
      "pricing.setup.price": "Tu presupuesto",
      "pricing.setup.price_note": "Pago único, facturado cuando entras en línea. Lo calculamos juntos en la llamada.",
      ...
      "pricing.monthly.price_amt": "Tu tarifa",
      "pricing.monthly.price_per": "/mes",
      "pricing.monthly.price_note": "Facturación mensual, acordada en la llamada. Cancela cuando quieras, con un mes de aviso.",
      ...
      // ---- pricing: CTA strip ----
      "pricing.strip.title": "Los precios son personales — no hay dos locales iguales.",
      "pricing.strip.body": "Una cafetería de 7 platos y un gastropub de 60 no son el mismo trabajo. Cuéntanos sobre tu local y te damos un número en la llamada.",
    ...
    de: {
      ...
      "pricing.intro": "Wir veröffentlichen keine festen Preislisten. Jedes Lokal ist anders — Kartengröße, Marke, Technik — deshalb erstellen wir für jeden Kunden nach einem kurzen Gespräch ein individuelles Angebot.",
      ...
      "pricing.setup.price": "Dein Angebot",
      "pricing.setup.price_note": "Einmalig, abgerechnet beim Go-live. Den Betrag ermitteln wir gemeinsam im Gespräch.",
      ...
      "pricing.monthly.price_amt": "Deine Rate",
      "pricing.monthly.price_per": "/Mon.",
      "pricing.monthly.price_note": "Monatlich abgerechnet, im Gespräch vereinbart. Jederzeit kündbar, mit einem Monat Frist.",
      ...
      // ---- pricing: CTA strip ----
      "pricing.strip.title": "Preise sind individuell — kein Lokal ist wie das andere.",
      "pricing.strip.body": "Ein Café mit 7 Gerichten und ein Gastropub mit 60 sind nicht dieselbe Aufgabe. Erzähl uns von deinem Lokal und wir nennen dir im Gespräch eine Zahl.",
    ...
    fr: {
      ...
      "pricing.intro": "Nous ne publions pas de tarifs fixes. Chaque établissement est différent — taille de la carte, marque, technologie — donc nous établissons un devis individuel après un bref appel.",
      ...
      "pricing.setup.price": "Ton devis",
      "pricing.setup.price_note": "Paiement unique, facturé à la mise en ligne. On définit le montant ensemble lors de l'appel.",
      ...
      "pricing.monthly.price_amt": "Ton tarif",
      "pricing.monthly.price_per": "/mois",
      "pricing.monthly.price_note": "Facturé chaque mois, convenu lors de l'appel. Annulable à tout moment, avec un mois de préavis.",
      ...
      // ---- pricing: CTA strip ----
      "pricing.strip.title": "Les prix sont personnels — aucun établissement ne se ressemble.",
      "pricing.strip.body": "Un café de 7 plats et un gastropub de 60 ne sont pas le même travail. Parle-nous de ton établissement et nous te donnerons un chiffre lors de l'appel.",
    ...
    pt: {
      ...
      "pricing.intro": "Não publicamos tarifas fixas. Cada espaço é diferente — dimensão da ementa, marca, tecnologia — por isso criamos um orçamento individual para cada cliente após uma breve chamada.",
      ...
      "pricing.setup.price": "O teu orçamento",
      "pricing.setup.price_note": "Pagamento único, faturado quando ficas online. Calculamos o valor juntos na chamada.",
      ...
      "pricing.monthly.price_amt": "A tua tarifa",
      "pricing.monthly.price_per": "/mês",
      "pricing.monthly.price_note": "Faturado mensalmente, acordado na chamada. Cancela quando quiseres, com um mês de aviso.",
      ...
      // ---- pricing: CTA strip ----
      "pricing.strip.title": "Os preços são pessoais — não há dois espaços iguais.",
      "pricing.strip.body": "Um café de 7 pratos e um gastropub de 60 não são o mesmo trabalho. Fala-nos do teu espaço e damos-te um valor na chamada.",
